                ...
                <div data-bs-spy="scroll" data-bs-target="#navbar-example3" data-bs-smooth-scroll="true" class="scrollspy-example-2" tabindex="0">
                    ...
                    <div id="item-1-1">
                        ...
                        <div class="alert alert-info" role="alert">
                            1. executable release - 07.11.2022 <br>
                            2. test - 07.15.2022 <br>
                            3. 1st doc - 08.04.2022 <br>
                            3. latest - 06.07.2023 <br>
                        </div>
                    ...
                    <div id="item-1-3">
                        <h3>Installation test log 1 (timestamp: 06.07.2023)</h3>
                        <div class="p-4 mb-3 bg-light rounded">
                            Python 3.11.4, conda 4.12.0, Github install (also PyPI), Windows10 (also Ubuntu 20.04)
                            <pre><code class="language-python">(tmkit) D:\Document\Programming\Python\deepbio\symphony\github\tmkit>pip install .
...
pyfiglet-0.8.post1 pypdb-2.2 python-dateutil-2.8.2 pytz-2023.3 requests-2.31.0 scikit-learn-1.3.0 scipy-1.11.1 six-1.16.0 threadpoolctl-3.1.0 tmkit-0.0.0.2 tzdata-2023.3 urllib3-2.0.3 xmltramp2-3.1.1</code></pre>

                        </div>
                        <h3>Installation test log 2 (timestamp: 06.07.2023)</h3>
                        <div class="p-4 mb-3 bg-light rounded">
                            Python 3.9.17, conda 4.11.0, PyPI, Ubuntu 20.04
                            <pre><code class="language-python">(tmkit) jsun@DESKTOP-68LV7AB:~$ pip install tmkit==0.0.2
...
Installing collected packages: pytz, pyfiglet, urllib3, tzdata, threadpoolctl, six, numpy, joblib, idna, et-xmlfile, charset-normalizer, certifi, xmltramp2, scipy, requests, python-dateutil, openpyxl, biopython, scikit-learn, pypdb, pandas, biopandas, tmkit
Successfully installed biopandas-0.4.1 biopython-1.79 certifi-2023.5.7 charset-normalizer-3.1.0 et-xmlfile-1.1.0 idna-3.4 joblib-1.3.1 numpy-1.25.0 openpyxl-3.1.2 pandas-2.0.3 pyfiglet-0.8.post1 pypdb-2.2 python-dateutil-2.8.2 pytz-2023.3 requests-2.31.0 scikit-learn-1.3.0 scipy-1.11.1 six-1.16.0 threadpoolctl-3.1.0 tmkit-0.0.2 tzdata-2023.3 urllib3-2.0.3 xmltramp2-3.1.1</code></pre>
                        </div>

                        <h3>Installation test log 3 (timestamp: 06.07.2023)</h3>
                        <div class="p-4 mb-3 bg-light rounded">
                            Python 3.10.12, conda 4.12.0, PyPI, Windows 10
                            <pre><code class="language-python">(tmkit1) C:\Users\jianf>pip install tmkit==0.0.2
Collecting tmkit==0.0.2
  Using cached tmkit-0.0.2.tar.gz (90 kB)
  Preparing metadata (setup.py) ... done
Collecting scikit-learn (from tmkit==0.0.2)
...
Installing collected packages: pytz, pyfiglet, urllib3, tzdata, threadpoolctl, six, numpy, joblib, idna, et-xmlfile, charset-normalizer, certifi, xmltramp2, scipy, requests, python-dateutil, openpyxl, biopython, scikit-learn, pypdb, pandas, biopandas, tmkit
Successfully installed biopandas-0.4.1 biopython-1.79 certifi-2023.5.7 charset-normalizer-3.1.0 et-xmlfile-1.1.0 idna-3.4 joblib-1.3.1 numpy-1.25.0 openpyxl-3.1.2 pandas-2.0.3
pyfiglet-0.8.post1 pypdb-2.2 python-dateutil-2.8.2 pytz-2023.3 requests-2.31.0 scikit-learn-1.3.0 scipy-1.11.1 six-1.16.0 threadpoolctl-3.1.0 tmkit-0.0.2 tzdata-2023.3 urllib3-2.0.3 xmltramp2-3.1.1</code></pre>
                        </div>
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
        <nav id="navbar-example3" class="h-100 flex-column align-items-stretch pe-4 border-end">
            <nav class="nav nav-pills flex-column">
                ...
                <nav class="nav nav-pills flex-column">
                    <a class="nav-link ms-3 my-1" href="#item-1-1">Logs</a>
                    <a class="nav-link ms-3 my-1" href="#item-1-2">Signature</a>
                    <a class="nav-link ms-3 my-1" href="#item-1-3">Installation log</a>
                </nav>
            </nav>
        </nav>
    </div>
