                ...
                <div data-bs-spy="scroll" data-bs-target="#navbar-example3" data-bs-smooth-scroll="true" class="scrollspy-example-2" tabindex="0">
                    <div id="item-1">
                        ...
                        <div class="text-center">
                            <img src="{{ URL::asset('img/lips.png') }}" class="img-thumbnail" alt="" width="800" height="400" loading="lazy">
                            <div class="pb-4 mb-4 fst-italic border-bottom">
                                <br><strong>Caption</strong>. Fig. 2. Schematic illustration of helical surfaces generated using the LIPS method. (a) shows the representations of the heptad repeat (seven residues ABCDEFG) in sequence and
                                structural contexts. (b) shows the seven canonical surfaces of transmembrane α-helices, which are generated by taking each of the seven residues as an anchoring residue. Each
                                surface consists of an anchoring residue and two residues complementing the anchoring residue. The seven surfaces are ADE, BEF, CFG, DGA, EAB, FBC, and GCD..
                            </div>
                        </div>
                    ...
                    <div id="item-1-1">
                        ...
                        <div class="alert alert-secondary" role="alert">
                            ...
                            <br><br>
                            Please note that <strong>TMKit</strong> has a method that is a wrapper of
...
{{--                            The file has been placed in <code>./data/external_lib/lips.pl</code>.--}}
